...
- **MQTT** protocol: understanding MQTT protocol is mandatory in case you need a back-end for your App (in order to interact with vehicles through Stellantis MQTT broker). If you don't need any back-end, MQTT knowledge is not mandatory.
