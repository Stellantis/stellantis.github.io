...
errorget:
  ...
  - code: 2102
# errorset: #TODO
short: This api allows to retrieve first and last trip in the local storage. See **SUBSCRIBE pims.vehicle.trips** for more informations about receiving trips in local storage.
component: 
  - TripNDrive
---