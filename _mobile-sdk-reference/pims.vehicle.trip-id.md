...
error:
  ...
  - code: 2101
  - code: 2102
short: This api allows to retrieve trip by **id** in the local storage. See **Subscribe** [pims.vehicle.trips](#api-pims-vehicle-trips) for more informations about receiving trips in local storage.
component: 
  - TripNDrive
---