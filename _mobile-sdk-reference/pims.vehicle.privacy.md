...
error: 
  ...
  - code: 2342
  - code: 2367
short: This api allows to get the vehicle privacy. This API require *sendToNav* being enable using [pims.vehicle.service - Start](#api-pims-vehicle-service-sendtonav).
textget: |-
