# FEATURE
Through Groupe PSA's {% if page.section == 'webapib2b' %}B2B{% elsif page.section == "webapib2c" %}B2C{% endif %} APIs you can access and browse data about your vehicles.
...
{% if page.section == 'webapib2b' %}> **Note:** one monitor is for one fleet only. Indeed you can creat multpile monitors for multiple fleets. {% endif %}
...
Below is a description of the JSON models explaining how to configure the callback. Please refer to {% if page.section == 'webapib2b' %}[API Reference]({{site.baseurl}}/webapi/b2b/reference){% elsif page.section == "webapib2c" %}[API Reference]({{site.baseurl}}/webapi/b2c/reference){% endif %} models to read a full description of the callback configuration.

**{% if page.section == 'webapib2b' %}[MonitorParameter]({{site.baseurl}}/webapi/b2b/reference/#model-MonitorParameter){% elsif page.section == "webapib2c" %}[MonitorParameter]({{site.baseurl}}/webapi/b2c/reference/#model-MonitorParameter){% endif %}**: this JSON object allow you to configure your monitor callback:
...
For the entire documentation, look closer at {% if page.section == 'webapib2b' %}[API Reference]({{site.baseurl}}/webapi/b2b/reference){% elsif page.section == "webapib2c" %}[[API Reference]({{site.baseurl}}/webapi/b2c/reference){% endif %}>**MonitorParameter>triggerParam>triggers**. 
...
Need to see examples of request to the API? Browse our {% if page.section == 'webapib2b' %}[Quick-Start]({{site.baseurl}}/webapi/b2b/quick-start/){% elsif page.section == "webapib2c" %}[Quick-Start]({{site.baseurl}}/webapi/b2c/quick-start/){% endif %}.
